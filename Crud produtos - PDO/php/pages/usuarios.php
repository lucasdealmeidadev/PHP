...
<div class="col sm-12" style="margin: 10px">
		<a href="javascript:modalAcoesUser();" class="waves-effect waves-light btn right modal-trigger"><i class="material-icons left">add</i> Cadastrar usuarios</a>
...
<div class="container" style="margin-top: 2em; margin-bottom: 2em">
	    ...
	    <div class="modal-content">
	       <h5 style="text-transform: uppercase; font-weight: 400;"><i class="small material-icons">add_circle</i> Cadastro de usuário</h5>
	       
		    <form method="POST" action="cadastro_usuarios" class="col s12" id="cad-usuarios">
	...
	<div id="modal_usuario_altera" class="modal modal-fixed-footer">
	    <div class="modal-content">
	       ...
	       <h5 style="text-transform: uppercase; font-weight: 400;"><i class="small material-icons">border_color</i> Alterar usuário</h5>
